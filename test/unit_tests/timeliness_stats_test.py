    ...
    def test_convert_to_hour(self):
        query_result = {
            "timeliness_statistics": {
                ...
                "sum_of_squares": 4.984272344666736e26,
                "variance": 2.7873981481624095e21,
                "variance_population": 2.7873981481624095e21,
                "variance_sampling": 2.7875332357919605e21,
        ...
        self.assertEqual(
            round(query_result["timeliness_statistics"]["min"], 4), 35.3108
        )
    ...
    def test_convert_to_hour_no_results(self):
        query_results = {
            "timeliness_statistics": {
                ...
                "std_deviation": None,
                "std_deviation_population": None,
                "std_deviation_sampling": None,
                "std_deviation_bounds": {
                    "upper": None,
                    "lower": None,
                    "upper_population": None,
                    "lower_population": None,
                    "upper_sampling": None,
                    "lower_sampling": None,
                },
            },
