...
import os
import unittest
from apps.ingestion.acq_plan_fragments import (
    AcqPlanFragments,
...
class AcqPlanGeoPlacemarksTestCase(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.s2_kml_filenames = ["S2A_MP_ACQ__KML_20230615T120000_20230703T150000.kml"]
    ...
    def test_min_lat_placemarks(self):
        ...
        self.assertTrue(
            "2023-06-07T17:49:47" in [str(pm.name) for pm in expected_allocation]
        )
