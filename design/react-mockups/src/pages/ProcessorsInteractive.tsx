...
import { ChevronDown, Calendar, Search, BarChart3, Clock, X } from 'lucide-react';
      ...
      <div className={s.filterBar}>
        ...
        <div className={s.viewToggle}>
          <button
            ...
            className={`${s.viewBtn} ${viewMode === 'gantt' ? s.active : ''}`}
          >
          ...
          <button
            ...
            className={`${s.viewBtn} ${viewMode === 'timeline' ? s.active : ''}`}
          >
        ...
        {selectedProcessor && (
          <div className={s.detailPanel}>
            <div className={s.detailHeader}>
              <h3 className={s.detailTitle}>Processor Details</h3>
              <button
...
function GanttView({
  ...
  onExpandGroup: (ipf: string | null) => void;
    ...
    <div className={s.ganttView}>
      ...
      {processors.map((group) => (
        <div key={group.ipf} className={s.ganttGroup}>
          <button
            onClick={() => onExpandGroup(expandedGroup === group.ipf ? null : group.ipf)}
          ...
          >
            <ChevronDown
              ...
              style={{
                color: 'var(--text-mute)',
                transform: expandedGroup === group.ipf ? 'rotate(180deg)' : 'rotate(0deg)',
