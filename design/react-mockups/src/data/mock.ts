...
export interface ModuleCard {
  ...
  pill: { label: string; status: Status }; metric: string; unit: string; desc: string; long: string;
...
export const MODULES: ModuleCard[] = [
  { idx: "01", href: "/acquisitions", title: "Acquisitions Status", img: "/assets/img/modules/acquisitions.jpg", pill: { label: "Live", status: "nominal" }, metric: "1,284", unit: "datatakes / 24h", desc: "Past, current and planned Sentinel acquisitions on an interactive 3D globe.", long: "The <b>Acquisitions Status</b> view displays the past, current and future Copernicus Sentinels' acquisition on an interactive, 3D globe. Through this view, users can either inspect the status of a past acquisition, or learn about the planned acquisitions for the mission of interest. By default, the real-time sensing scenario is displayed." },
  { idx: "02", href: "/events", title: "Events", img: "/assets/img/modules/events.jpg", pill: { label: "3 open", status: "degraded" }, metric: "12", unit: "events / 3 months", desc: "Calibration activities, manoeuvres and anomalies that could impede data production.", long: "The <b>Events</b> page provides details of the events over the past three months that could impede data production, such as planned calibration activities, manoeuvres, or anomalies. Information on the extent to which these events affect data production and the data products impacted is provided." },
  { idx: "03", href: "/availability", title: "Data Availability", img: "/assets/img/modules/availability.jpg", pill: { label: "98.4%", status: "nominal" }, metric: "98.4", unit: "% availability", desc: "Real-time list of available collections delivered by the missions, with key metrics.", long: "The <b>Data Availability</b> section of the dashboard hosts a real-time list of available collections delivered by the missions, enabling users to scan through these products to find data that meet their research and development requirements, to verify whether specific data of interest is available, check its current status and review key availability metrics such as availability percentage." },
  { idx: "04", href: "/processors", title: "Processors", img: "/assets/img/modules/processors.jpg", pill: { label: "Baseline 003.71", status: "info" }, metric: "47", unit: "releases tracked", desc: "The complete list of Copernicus Sentinel processor releases on an interactive timeline.", long: "The <b>Processors</b> tab shows the complete list of the releases of the Copernicus Sentinels processors, on an interactive timeline. The timeline can be zoomed in / out using the mouse wheel, and dragged to the left / right by moving the mouse while keeping left-hand button pressed. By clicking on a coloured box, the details relevant to the selected processor release is displayed in the lower part of the screen." },
];
