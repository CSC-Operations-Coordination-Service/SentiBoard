...
try:
    ...
    def format_str(src_contents: str, mode=None) -> str:
        return src_contents

try:
    from maas_model.generator.meta import FieldMeta, ModelClassMeta
except ModuleNotFoundError as error:
    # Support direct script execution: python maas_model/generator/pygen.py ...
...
if __name__ == "__main__":
    ...
    mode = FileMode() if FileMode is not None else None
    print(format_str(generate(*sys.argv[1:]), mode=mode), end="")