...
<div class="cookie-toggle">
  <div class="status" id="cookie-status">Your current status: <b>Opted in</b></div>
  <div class="actions">
    <button class="btn primary" id="cookie-accept">I accept cookies</button>
    <button class="btn" id="cookie-refuse">I refuse cookies</button>
  </div>
</div>
