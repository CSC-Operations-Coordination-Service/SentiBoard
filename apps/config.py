...
from apps.cache.cache import (
    ConfigCache,
    PublicationProductTreeCache,
    MissionTimelinessCache,
)


def read_config_file(filename):
    BASE_CONFIG_PATH = os.getenv("BASE_CONFIG_PATH", "apps/config/")
    full_path = os.path.join(BASE_CONFIG_PATH, filename)
