...
def create_app(config):
    ...
    def robots_txt():
        ...
        if "staging.sentiboard.onda-dias.com" in host:
            ...
            User-agent: *
            Allow: /
            Sitemap: https://ocs.staging.sentiboard.onda-dias.com/sitemap.xml
            """
        else:
   ...
   # --- Manifest.json route (dynamic for prod URLs) ---
    ...
    def inject_page_url_and_keywords():
        ...
        return dict(page_url=page_url, seo_keywords=seo_keywords, seo_description=seo_description, get_keywords=get_keywords)
